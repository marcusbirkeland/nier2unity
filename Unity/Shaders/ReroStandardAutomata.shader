...
Shader ".Rero/Rero Standard/ReroStandardAutomata"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "CGINCAUTOMATA/UnityStandardCoreForwardRero.cginc"
        ...
        Pass
        {
            ...
            #include "CGINCAUTOMATA/UnityStandardCoreRero.cginc"
