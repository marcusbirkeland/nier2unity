...
Shader ".Rero/Rero Standard/ReroStandardReplicant"
{
    Properties
    {
        ...
        [Enum(UV0,0,UV1,1)] _UVPrimary ("UV Set for primary texture", Float) = 0
		...
		[Toggle(_)] _AdvancedChannels("Advanced Channel Features", Float) = 1
		_metallicChannel(" ", Float) = 2
		_occlusionChannel(" ", Float) = 0
		_heightChannel(" ", Float) = 0
		_glossChannel(" ", Float) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "CGINCREPLICANT/UnityStandardCoreForwardRero.cginc"
        ...
        Pass
        {
            ...
            #include "CGINCREPLICANT/UnityStandardCoreRero.cginc"
